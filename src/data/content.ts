...
export const content: Record<Lang, LangContent> = {
  en: {
    ...
    bio: [
      "Hi, I'm Mehdi Semmar, a Software Engineering student at the University of Ottawa. Across five co-op terms I've worked in government, as a full-stack developer in [public safety](/blog/versaterm), an AI/ML engineer in [automotive R&D](/blog/raven), and an AI software engineer in fintech. Moving between them taught me to adapt fast to new environments and new tech.",
      "When I'm not on a co-op, I'm building something of my own. I co-founded and incorporated [RZO Sports](/blog/rzo), a marketplace connecting athletes with sports venues that placed second of 40 teams in a pitch competition. I also like showing up for my community, on the dev team for uOttaHack 8, co-directing SESA (Software Engineering Student Association), and TAing software engineering courses.",
  ...
  fr: {
    ...
    bio: [
      "Bonjour, je suis Mehdi Semmar, étudiant en génie logiciel à l'Université d'Ottawa. En cinq stages coop, j'ai travaillé dans le gouvernement, comme développeur full-stack en [sécurité publique](/blog/versaterm), ingénieur en apprentissage automatique en [R-D automobile](/blog/raven), et ingénieur logiciel en IA dans la fintech. Passer de l'un à l'autre m'a appris à m'adapter vite à de nouveaux milieux et à de nouvelles technologies.",
      "Quand je ne suis pas en stage, je construis quelque chose à moi. J'ai cofondé et incorporé [RZO Sports](/blog/rzo), une place de marché reliant les athlètes aux terrains de sport, arrivée deuxième sur 40 équipes dans un concours de pitch. J'aime aussi m'impliquer dans ma communauté : équipe de développement d'uOttaHack 8, codirection de SESA (Association des étudiants en génie logiciel), et assistant d'enseignement pour des cours de génie logiciel.",

...
export const content: Record<Lang, LangContent> = {
  en: {
    ...
    bio: [
      "Hi, I'm Mehdi Semmar, a Software Engineering student at the University of Ottawa with a habit of collecting new sectors. Across five co-op terms I've worked in government, as a full-stack developer in [public safety](/blog/versaterm), an ML engineer in [automotive telematics and R&D](/blog/raven), and an AI software engineer in [fintech](/blog/vertex). The throughline: drop me into an unfamiliar stack and I'll start building.",

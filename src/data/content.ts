...
export const content: Record<Lang, LangContent> = {
  en: {
    ...
    bio: [
      ...
      "When I'm not on a co-op, I'm building something of my own. I co-founded and incorporated [RZO Sports](/blog/rzo), a marketplace connecting athletes with sports venues that placed second of 40 teams in a pitch competition. I also like showing up for my community, on the dev team for uOttaHack 8, leading events for SESA, and TAing software engineering courses.",
  ...
  fr: {
    ...
    bio: [
      ...
      "Quand je ne suis pas en stage, je construis quelque chose à moi. J'ai cofondé et incorporé [RZO Sports](/blog/rzo), une place de marché reliant les athlètes aux terrains de sport, arrivée deuxième sur 40 équipes dans un concours de pitch. J'aime aussi m'impliquer dans ma communauté : équipe de développement d'uOttaHack 8, direction des événements de SESA, et assistant d'enseignement pour des cours de génie logiciel.",
